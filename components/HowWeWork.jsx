...
import { PenTool, Rocket, Search, Sparkles, Video } from 'lucide-react';
...
export default function HowWeWork() {
	...
	return (
		<section
			ref={containerRef}
			className='relative bg-[#fcfcfd] py-32 overflow-hidden'
			id='HowWeWork'>
			...
			<div className='container mx-auto px-6 relative z-10'>
				<div className='flex flex-col md:flex-row gap-16'>
					<div className='md:w-1/3 md:sticky md:top-32 h-fit'>
						...
						<h2 className="text-5xl md:text-5xl font-['Helvetica'] font-black text-slate-900 leading-[0.9] tracking-tighter mb-8">
							How <br />{' '}
						...
						<p className='text-slate-500 text-lg font-medium leading-relaxed'>
							We don't just provide services; we build integrated growth ecosystems that scale with
							you.
						</p>
					</div>
					<div className='md:w-2/3 relative pl-8 md:pl-20'>
						<div className='absolute left-0 md:left-10 top-0 w-[2px] h-full bg-slate-200'>
							<motion.div
								style={{ scaleY }}
								...
								<motion.div
									...
									<div className='absolute -left-[41px] md:-left-[51px] top-0 flex items-center justify-center'>
										<motion.div
											...
											<span className="text-xs font-black font-['Helvetica'] text-slate-900">
												{s.n}
											</span>
										</motion.div>
									</div>
									...
									<div className='flex flex-col md:flex-row gap-8 items-start'>
										<div className='relative'>
											<div
												className={`p-5 rounded-3xl bg-gradient-to-br ${s.gradient} text-white shadow-2xl relative z-10 group-hover:-rotate-12 transition-transform duration-500`}>
												{s.icon}
											</div>
											<div
												className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${s.gradient} blur-2xl opacity-20 group-hover:opacity-60 transition-opacity`}
											/>
										</div>
