				...
				<motion.div
					...
					<motion.div
						...
						<p className='mb-4 text-[17px] leading-[1.85] text-slate-900/70'>
							The teams behind <b className='text-slate-900/90'>Synchroyst</b> have worked inside
							and alongside some of the most demanding organizations in the world environments where
							growth systems must operate at massive scale.
						</p>

						<p className='mb-4 text-[17px] leading-[1.85] text-slate-900/70'>
							Our people have been trained under <b className='text-slate-900/90'>Fortune 500</b>,{' '}
							<b className='text-slate-900/90'>Fortune 100</b>, and{' '}
							<b className='text-slate-900/90'>Fortune 1-level</b> companies, where systems are
							designed before they are deployed, and failure is costly and unacceptable.
						</p>
						...
						<div className='relative mt-4 overflow-hidden rounded-[18px] bg-[radial-gradient(900px_circle_at_20%_0%,rgba(59,130,246,0.14),transparent_55%),radial-gradient(900px_circle_at_80%_100%,rgba(168,85,247,0.12),transparent_55%)] px-[18px] pb-4 pt-[18px]'>
							...
							<p className='m-0 pl-[14px] text-[18px] font-extrabold text-slate-900/90'>
								We are bringing that same operating discipline without enterprise overhead to
								businesses that are ready to grow properly.
							</p>
						</div>
					</motion.div>
